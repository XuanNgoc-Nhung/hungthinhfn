            ...
            <div class="container" style="padding: 0px !important;">
                ...
                <div class="vay-body">
                    ...
                    <div class="input-container">
                        <el-input @input="tinhTienHangThang" placeholder="Nhập số tiền cần vay" type="number" :min="20000000" :max="500000000" v-model="thongTinVay.soTien" ></el-input>
                    </div>
                    <div class="subtitle"><span class="ant-typography">Từ 20.000.000đ</span><span
                        class="ant-typography">Đến 500.000.000đ</span></div>
                    <div class="month-container" style="padding: 10px;"><span class="ant-typography">Chọn thời hạn vay</span>
                        <div tabindex="0" class="ant-select ant-select-enabled"
                             style="border-radius: 100px; min-width: 150px;">
                            <el-select v-model="thongTinVay.thoiHan" placeholder="Chọn" @change.prevent="tinhTienHangThang">
                                <el-option
                    ...
                    <div class="information-form"><span class="ant-typography form-title"
                        ...
                        <div class="information">
                            <div class="details-information"><span class="ant-typography">Số tiền</span><span
                                class="ant-typography">{{parseInt(thongTinVay.soTien).toLocaleString()}} đ</span></div>
                ...
                <div>
                    <div class="old-debt-text"><span class="ant-typography"
                        ...
                        class="ant-typography" style="flex: 2 1 0%; color: rgb(62, 62, 62); font-size: 16px;">{{parseInt(thongTinVay.traKyDau).toLocaleString()}} VND</span>
                    </div>
                    <div class="old-debt-text"><span class="ant-typography"
                                                     style="flex: 2 1 0%; color: rgb(102, 102, 102); font-size: 14px;">Lãi suất hàng tháng</span><span
                        class="ant-typography" style="flex: 2 1 0%; color: rgb(62, 62, 62); font-size: 16px;">{{(thongTinVay.laiSuat).toFixed(2)}}%</span>
                    </div>
                    <div class="old-debt-text"><a class="ant-typography">Chi tiết trả nợ</a></div>
                </div>
                <div class="btn-container">
                    <button type="button" class="ant-btn ant-btn-default confirm-btn"><span
