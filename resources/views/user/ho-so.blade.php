                ...
                <div style="opacity: 1; transform: none;">
                    ...
                    <div>
                        <div class="avatar"><span class="ant-avatar ant-avatar-circle ant-avatar-image"
                                                  style="width: 120px; height: 120px; line-height: 120px; font-size: 18px;"><img
                                    src="https://hungthinhfn.com/uploads/cmnd/12-08-2023-58a160f1ddc25df50044849252f0603d90898.jpg"></span>
                            <span class="ant-typography"
                                  style="font-size: 23px; color: rgb(18, 18, 18);"><strong>ádasa</strong></span> <span
                                class="ant-typography"
                                style="font-size: 18px; color: rgb(102, 102, 102); font-weight: 500;">0332332332</span>
                        </div> <!---->
